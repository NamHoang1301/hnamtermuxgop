...
\033[1;34m└═════════════════════════════════════════════════════════════════════════════┘
\033[1;34m ➯ Loại Tool: \033[1;37mSpam Sms + Call
\033[1;34m└═════════════════════════════════════════════════════════════════════════════┘
...
if chon == 1 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/spamsmsv1.py').text)
elif chon == 2 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/spamsmsv2.py').text)
if chon == 3 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/spamsmsv3.py').text)
elif chon == 0 :
