...
\033[1;34m└═════════════════════════════════════════════════════════════════════════════┘
\033[1;34m ➯ Loại Tool: \033[1;37mCày Tiền Golike
\033[1;34m└═════════════════════════════════════════════════════════════════════════════┘
...
if chon == 1 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/golikev1.py').text)
elif chon == 2 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/golikev2.py').text)
elif chon == 0 :
