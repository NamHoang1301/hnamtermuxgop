...
\033[1;34m└═════════════════════════════════════════════════════════════════════════════┘
\033[1;34m ➯ Loại Tool: \033[1;37mProxy
\033[1;34m└═════════════════════════════════════════════════════════════════════════════┘
...
if chon == 1 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/genproxyv1.py').text)
elif chon == 2 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/genproxyv2.py').text)
elif chon == 3 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/genproxyv3.py').text)
elif chon == 4 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/genproxyv4.py').text)
elif chon == 5 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/locproxyv1.py').text)
elif chon == 6 :
	exec(requests.get('https://raw.githubusercontent.com/NamHoang1301/hnamtermuxtool/main/locproxyv2.py').text)
elif chon == 0 :
